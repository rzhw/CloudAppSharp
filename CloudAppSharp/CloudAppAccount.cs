    ...
    public partial class CloudApp
    {
        ...
        public void ChangeEmail(string newEmail, string currentPassword)
        {
            HttpWebRequest wr = CreateRequest("http://my.cl.ly/account", "PUT",
                JsonHelper.Serialize<CloudAppChangeEmail>(new CloudAppChangeEmail(newEmail, currentPassword)));
        ...
        {
            HttpWebRequest wr = CreateRequest("http://my.cl.ly/account", "PUT",
                JsonHelper.Serialize<CloudAppChangePassword>(new CloudAppChangePassword(newPassword, currentPassword)));
